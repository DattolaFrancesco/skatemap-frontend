...
export default function InfoUser(){
    ...
    async function getSpot(){
        try{
            const res = await fetch(`${API}/spots/own`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem('token')}`
    ...
    async function getFavs(){
        try{
            const res = await fetch(`${API}/fav/all`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem('token')}`
            ...
            <div>
                <div className="w-full flex flex-col md:flex-row justify-between mb-3">
                    ...
                    <div className="flex justify-center md:justify-end gap-3">
                        ...
                        <div className="flex flex-col justify-center items-center">
                            <p className="text-3xl md:text-6xl bg-transparent font-sans text-primary-700">{spotFav?.length}</p>
