...
//                 <div className="w-full h-full flex justify-center items-center">
//                     <div ref={permissionPendingRef} className={`w-2/3 md:full bg-amber-50 ${loading ? "animate-pulse" : ""}`}>
//                         <h1 className="text-orange-500 text-center text-xl md:text-4xl p-5">DO YOU REALLY WANT TO SET {eliminationSpot?.name} AS PENDING ?</h1>
//                         <div className="flex justify-center gap-3 p-3">
